   ...
   <Sidebar expand={expand} setExpand={setExpand} />
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
        ...
        {messages.length === 0 ? (
          <>
            <div className="flex items-center gap-3">
              ...
              <p className="test-2xl font-medium">Hi, I'm DeepSeek.</p>
            </div>
        ...
        (
          ...
          <p className="fixed top-8 border border-transparent hover:border-grey-500/50 py-1 px-2 rounded-lg font-semibold mb-6">{selectedChat.name}</p>
