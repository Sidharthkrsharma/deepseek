  ...
  return (
    ...
    <div>
      <div className={`flex ${expand ? 'flex-row gap-10' : 'flex-col items-center gap-8'}`}>
        ...
        <div onClick={()=> expand ? setExpand(false) : setExpand(true)} className='group relative flex items-center justify-center hover:bg-grey-500/20 transition-all duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer'>
    ...
    <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shodow-lg"> 
